 ...
 * Use the [UsuarioFavoritosFragment.newInstance] factory method to
...
class UsuarioFavoritosFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment UsuarioFavoritosFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            UsuarioFavoritosFragment().apply {
